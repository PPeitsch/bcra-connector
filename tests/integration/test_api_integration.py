...
from bcra_connector.estadisticas_cambiarias import Divisa, CotizacionFecha
...
class TestBCRAIntegration:
    ...
    def test_get_principales_variables(self) -> None:
        ...
        variables: List[PrincipalesVariables] = self.connector.get_principales_variables()
    ...
    def test_currency_evolution(self) -> None:
        ...
        assert all(
            any(d.codigo_moneda == "USD" for d in cf.detalle)
            for cf in evolution
        )
