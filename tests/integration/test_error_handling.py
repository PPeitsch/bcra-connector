...
class TestErrorHandling:
    ...
    def strict_rate_limit_connector(self) -> BCRAConnector:
        ...
        return BCRAConnector(
            verify_ssl=False,
            rate_limit=RateLimitConfig(calls=1, period=2.0)
        )
    ...
    def test_connection_error(self) -> None:
        ...
        assert any(
            term in error_msg 
            for term in ["connection", "dns", "timeout", "refused"]
        )
    ...
    def test_invalid_date_range(self, strict_rate_limit_connector: BCRAConnector) -> None:
    ...
    def test_invalid_variable_id(self, strict_rate_limit_connector: BCRAConnector) -> None:
    ...
    def test_response_validation(self, strict_rate_limit_connector: BCRAConnector) -> None:
